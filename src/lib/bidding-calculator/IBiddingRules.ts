export default interface IBiddingRules {
    ...
    startingAmountFormulaType: 'PreviousLowestBid' | 'MinimumBreakeven' | 'OptimisticBreakeven' | 'Custom';
    startingAmountFormulaIncrease: number;
    startingAmount: number;
    rebiddingDelay: number;
    incrementAmount: number;
    finalAmountFormulaType: 'PreviousHighestBid' | 'MinimumBreakeven' | 'OptimisticBreakeven' | 'Custom';
