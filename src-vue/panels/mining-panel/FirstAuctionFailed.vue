<template>
  ...
  >
    <div class="relative mx-auto inline-block w-6/10">
      <h1
        class="text-4xl font-bold text-gray-600 text-center mt-32 mb-1 whitespace-nowrap border-t border-gray-300 pt-10"
      >
        YOUR BIDDING BOT
      </h1>

      <div class="flex flex-col items-center justify-center min-h-[75px]">
        <div class="text-6xl text-center text-gray-600 font-bold">FAILED TO WIN A BID</div>
      </div>
      <p
        class="text-center text-lg mt-6 border-t border-b border-gray-300 pt-8 pb-7 font-light leading-7.5 inline-block"
      >
        The current auction has climbed above the Maximum Price you set in your budget. This means
        your bot can no longer bid. Modify your Bidding Rules if you wish to resume.
      </p>
