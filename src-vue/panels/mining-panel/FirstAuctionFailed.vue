<template>
  ...
  >
    <div class="relative mx-auto inline-block w-6/10">
      <div
        class="text-5xl font-bold text-gray-600 text-center mt-32 mb-4 whitespace-nowrap border-t border-gray-300 pt-16"
      >
        YOUR BIDDING BOT
      </div>
      <div class="flex flex-col items-center justify-center min-h-[75px]">
        <div class="text-7xl text-center text-gray-600 font-bold whitespace-nowrap">
          FAILED TO WIN A BID
        </div>
      </div>
      <p
        class="text-center text-lg mt-10 border-t border-b border-gray-300 pt-8 pb-7 font-light leading-7.5 inline-block"
      >
        The current auction has climbed above the Maximum Price set in your budget. This means
