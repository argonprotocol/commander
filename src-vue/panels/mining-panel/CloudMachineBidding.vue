  ...
  <div class="flex flex-col h-full text-[#3E444E]">
    ...
    <div class="grow m-4 relative">
      ...
      <div class="relative z-10">
        ...
        <div v-if="isClosing" isClosing class="text-center text-9xl mt-10 font-bold text-slate-700/70">
          CLOSING
        </div>
        ...
        <button @click="openBidderDialog" class="bg-[#A600D4] text-2xl font-bold text-white px-10 py-2 rounded-md mx-auto block mt-10 cursor-pointer">
          Open Bidding Panel
        </button>
