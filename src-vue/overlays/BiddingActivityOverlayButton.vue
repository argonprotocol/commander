<template>
  <Popover as="div" class="relative text-center text-lg font-bold mt-10">
    <PopoverButton class="focus:outline-none border border-argon-300 whitespace-nowrap text-argon-600 px-7 py-2 rounded cursor-pointer hover:bg-argon-50/40 hover:border-argon-600 transition-all duration-300">
