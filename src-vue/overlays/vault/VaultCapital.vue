  ...
  <TooltipProvider :disableHoverableContent="true" :delayDuration="0">
    <TooltipRoot>
      ...
      <TooltipPortal>
        ...
        >
          <p>
            This box shows the argon value being invested in your vault. This capital is used both to help secure the
            network's bitcoin and to invest in the network's treasury pools. You can adjust the split on this screen.
          </p>
