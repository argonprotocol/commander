                ...
                <ul Steps class="flex flex-col gap-4 w-full">
                  ...
                  <li>
                    ...
                    <div wrapper>
                      <div>
                        <p>
                          You should use all the default options when creating your new droplet, including Digital Ocean's default image. It should be set to Ubuntu version 24.10 x64.
                        </p>
                        <p>
                          Keep on scrolling.
                        </p>
                  ...
                  <li>
                    ...
                    <div wrapper>
                      <div>
                        ...
                        <p>
                          For the "CPU Options" select "Premium Intel" and then the $32/mo. This is plenty of power for Argon mining. Hopefully you have $200 in credits which makes this free.
                        </p>
                      </div>
                  ...
                  <li>
                    ...
                    <div wrapper>
                      <div>
                        <p>
                          Skip down to the "Choose Authentication Method" and select "SSH Key" then "Add SSH Key". This will pop up an overlay with a text box.
                        </p>
                        <p>
                  ...
                  <li>
                    ...
                    <div wrapper>
                      <div>
                        <p>
                          Under "Finalze Details", you can optionally customize the hostname of your server. This is used in Digital Ocean's control panel to identify your server (by default they use a long convoluted name). Use whatever name you want. It is for your eyes only.
                        </p>
                        <p>
                          Click the "Create Droplet" button, and wait for your new server to boot up.
                        </p>
                      </div>
                  ...
                  <li>
                    ...
                    <div wrapper>
                      <div>
                        ...
                        <input type="text" v-model="ipAddress" placeholder="Your Server's IP Address" class="w-full border bg-white border-slate-300 rounded-md px-4 py-4" />
                      </div>
